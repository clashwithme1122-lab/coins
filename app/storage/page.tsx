  ...
  const storagePlans = [
    {
      ...
      features: ['Climate-controlled vault', 'Individual sealed containers', '24/7 surveillance', 'Insurance coverage up to $10,000', 'Online inventory access'],
      recommended: false
    },
    {
      id: 'collector',
      ...
      features: ['Premium climate control', 'Custom display options', 'Priority access', 'Insurance coverage up to $50,000', 'Professional appraisal included', 'Quarterly condition reports'],
      recommended: true
    },
    {
      id: 'institutional',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          >
            ...
            <p className="text-xl text-purple-100 max-w-2xl mx-auto">
              Bank-level security and climate-controlled storage for your valuable coin collection. Protect your investment with professional vault services.
            </p>
          </motion.div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {storagePlans.map((plan, index) => (
            <motion.div
              ...
              className={`bg-white rounded-xl shadow-lg p-6 cursor-pointer transition-all relative ${
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Visit your collection by appointment during business hours</p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Our staff can retrieve specific coins for inspection</p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Insured delivery to your location for viewing</p>
                  </div>
                </div>
              </div>
            </motion.div>
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">View your complete collection with photos and details</p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Regular reports on coin condition and environmental status</p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Market value updates and appraisal reports</p>
                  </div>
                </div>
              </div>
            </motion.div>
